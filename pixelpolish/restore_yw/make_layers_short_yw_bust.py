...
LAY_DIR = Path(r"D:\PixelPolish\plates\layers_yw_bust")
WORK_ROOT = Path(r"D:\PixelPolish\video\projects\layers_youngwoman1855_bust")
...
EXPO_TARGET = 88.0       # A3: средняя яркость кадра 130-140
RB_TARGET = 3.0          # F1: B ниже R не больше чем на 10-12
SAT_TARGET = 0.07         # F3
...
WANT = [
    ("1855",                            110,  820,  0.00,  3.20, None),
    ("Rochester, New York",              58,  980,  0.00,  3.20, None),
    ("her name was never recorded",      48, 1000,  3.55,  6.10, None),
    ("the brass mat is stamped F. Grice",48, 1000,  6.45,  8.35, None),
    ("warmth back in her face",          48, 1000,  8.70, 11.00, "color_face"),
    ("her hands, folded and still",      48, 1000, 11.35, 12.50, None),
    ("the sheer yoke, stripe by stripe", 48, 1000, 12.95, 15.30, "detail"),
    ("the color she was painted in",     48, 1000, 16.20, 18.60, "color_full"),
    ("one young woman, no name",         48, 1000, 18.95, 21.30, None),
    ("she held still for half a minute", 48, 1000, 21.65, 24.00, None),
    ("the plate survived 171 years",     48,  930, 24.00, 27.00, None),
    ("AI restoration",                   44, 1030, 24.00, 27.00, None),
    ("Library of Congress \u00b7 Public Domain",
                                         44, 1092, 24.00, 27.00, None),
    ("Who was she?",                     92,  880, 27.00, 30.00, None),
]
