...
проходит меньше ~0,35 px за кадр, соседние кадры выходят побитово одинаковыми
и движение читается как рывки. Замеры — ФОРМАТ_V5.md, группа J.
...
MIN_TRAVEL_PX_PER_FRAME = 0.35   # ниже — многокадровые заморозки, см. J.3
